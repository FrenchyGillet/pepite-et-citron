...
if (SENTRY_DSN) {
  Sentry.init({
    ...
    release: import.meta.env.VITE_APP_VERSION,   // optionnel
    // Ne capture que les erreurs non gérées — pas les console.error intentionnels
    integrations: [
      Sentry.browserTracingIntegration(),
    ],
    // 10 % des sessions en production pour le profiling
    tracesSampleRate: import.meta.env.MODE === "production" ? 0.1 : 0,
    // Ignore les erreurs réseau bénignes
    ignoreErrors: [
      "AbortError",
      "Délai dépassé",
      "NetworkError",
